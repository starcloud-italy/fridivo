    ...
    with bootstrap_engine.begin() as connection:
        connection.execute(
            text(
                ...
                "quantity TEXT, categories TEXT, image_url TEXT, nutriscore_grade TEXT)"
            )
        )
        ...
        connection.execute(
            text(
                ...
                "(id, code, product_name, brands, quantity, categories, image_url, nutriscore_grade, marker) "
                "VALUES "
                "(1, '0801234567890', 'Pasta integrale', 'Fridivo Test', '500 g', "
                " 'Pasta, Cereals', 'https://images.test/pasta.jpg', 'a', 'fixture'), "
                "(2, '8001234567895', 'Salsa per pasta', 'Dispensa Test', '350 g', "
                " 'Sauces', NULL, 'b', 'fixture'), "
                "(3, '8001234567896', 'Acqua naturale', 'Fonte Test', '1.5 L', "
                " 'Beverages, Waters', NULL, 'a', 'fixture'), "
                "(4, '4001234567890', 'Dark chocolate', 'Europe Test', '100 g', "
                " 'Snacks, Chocolate', NULL, 'd', 'fixture') "
